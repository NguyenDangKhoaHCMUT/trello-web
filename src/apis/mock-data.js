  ...
  board: {
    ...
    columns: [
      ...
      },
      {
        ...
        // Video 37.2: Cách xử lý trong logic thư viện DndKit khi Column là rỗng
        ...
        // Kỹ hơn nữa về cách tạo chuẩn ở bước nào thì sẽ ở học phần tích hợp API-BE vào dự án (Bởi vì đây là file mockData)
