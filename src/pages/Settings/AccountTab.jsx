...
function AccountTab() {
  ...
  const initialGeneralForm = {
    // displayName là trường đã được register ở dưới
  ...
  const uploadAvatar = (e) => {
    ...
    toast.promise(
      ...
      // Lưu ý, dù có lỗi hay không thì cũng phải reset lại input file
      // để tránh trường hợp upload lại file CŨ thì không có sự kiện onChange nào xảy ra
      e.target.value = ''
    })
  }
